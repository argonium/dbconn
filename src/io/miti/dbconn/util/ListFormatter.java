...
public final class ListFormatter
{
  ...
  {
//    List<TableInfo> z = new ArrayList<TableInfo>(10);
//    z.add(new TableInfo("abc", "def", "ghi", null));
//    z.add(new TableInfo("abc1", "def", "ghi", "url1"));
//    String table = new ListFormatter().getTable(z, new String[]{"userName", "url"}, new String[]{"User", "URL"});
//    System.out.println(table);
    
    /*
    List<List<String>> list1 = new ArrayList<List<String>>(10);
    ...
    list3.add("a");
    list3.add("abcde");
    list3.add("adadfasdfasdfasf");
    list3.add("adadfadfsaf");
    list3.add("adfadf");
    
    list1.add(list2);
    list1.add(list3);
    ListFormatter fmt = new ListFormatter(list1);
    fmt.printWidthList();
    List<String> format = fmt.format(5, list1);
    for (int i = 0; i < format.size(); ++i)
    {
      System.out.println(format.get(i));
    }
    */
  }
}
